...
class Base(Configuration):
    ...
    TWITTER_CONSUMER_KEY = SecretValue(
        environ_name="TWITTER_CONSUMER_KEY",
        environ_prefix=None
    )
    TWITTER_CONSUMER_SECRET = SecretValue(
        environ_name="TWITTER_CONSUMER_SECRET",
        environ_prefix=None
    )
    TWITTER_ACCESS_TOKEN = SecretValue(
        environ_name="TWITTER_ACCESS_TOKEN",
        environ_prefix=None
    )
    TWITTER_ACCESS_TOKEN_SECRET = SecretValue(
        environ_name="TWITTER_ACCESS_TOKEN_SECRET",
        environ_prefix=None
    )

    NUMBER_OF_TWEETS = 150

    # GOOGLE Credentials [NLP]
    GOOGLE_AUTH_TOKEN = "/Users/MichaelButnaru/Desktop/GitHub/MB-API-BTC/crypto_service/google_event_service/application-189720-197a8963c90e.json"
